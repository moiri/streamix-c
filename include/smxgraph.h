 ...
 * @param is_dyn_src has the source port a dynamic conncetion
 * @param is_dyn_dst has the destination port a dynamic conncetion
 */
 ...
 * @param attr_location enum attribute
 */
